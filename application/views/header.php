		...
		<div class="header-quick-nav"> 
			...
			<li class="quicklinks"> 
				...
				<ul class="dropdown-menu  pull-right" role="menu" aria-labelledby="user-options">
                	<li><a href="<?php print site_url('list_user/edit_profile/'.$this->session->userdata('user_id')); ?>"><i class="fa fa-user"></i>&nbsp;&nbsp;View Profile</a></li>
                     <li><a href="<?php print site_url('schedule'); ?>"><i class="fa fa-calendar"></i>&nbsp;&nbsp;My Schedule</a></li>
                     <li class="divider"></li>

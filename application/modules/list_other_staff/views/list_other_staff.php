...
<script type="text/javascript" src="<?php print base_url(); ?>js/grid/list_other_staff.js?t=newv"></script>
<div id="admin">
<?php 
if($this->session->userdata('role_id') == '1' || in_array("add",$this->arrAction))
{
?>
	<div id="add_model_link" class="hide"><a href="list_user/add_profile/other" class="btn btn-success"><?php echo $this->lang->line('add_new'); ?> <i class="fa fa-plus"></i></a></div>
<?php
} 
?>
<!-- Modal -->

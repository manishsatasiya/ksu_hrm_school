...
<script type="text/javascript" src="<?php print base_url(); ?>js/grid/contractors.js"></script>
...
?>
	<div id="add_model_link" class="hide">
		<a href="contractors/add" class="btn btn-success" data-target="#myModal" data-toggle="modal"><?php echo $this->lang->line('add_new'); ?> <i class="fa fa-plus"></i></a>
	</div>	
<?php 
}
?>
...
<div class="row-fluid">
	<div class="span12">
		<div class="grid simple ">
			...
			<table class="table" id="grid_contractors">
				<thead>
					<tr>

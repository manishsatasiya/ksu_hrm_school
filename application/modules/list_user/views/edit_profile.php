                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane" id="tab2"> <br>
							...
							<div class="row form-row">
                              ...
                              <div class="col-md-3"> <?php print form_label('Campus Privilages', 'campus_privilages_id',array('class'=>'form-label')); ?> <?php print form_dropdown('campus_privilages_id',$campus_list,($user_data)?$user_data->campus_id.'j':$this->session->flashdata('campus_id'),'id="campus_id" class="select2 form-control"'); ?> </div>
                              ...
                              <div class="col-md-3"> <?php print form_label('Line Manager', 'coordinator',array('class'=>'form-label')); ?> <?php print form_dropdown('coordinator',$line_manager_list,($user_data)?$user_data->coordinator:$this->session->flashdata('coordinator'),'id="coordinator" class="select2 form-control"'); ?> </div>
                            </div>
							<div class="row form-row">

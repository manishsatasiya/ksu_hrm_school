...
<div class="col-md-12">
  <div class="tabbable tabs-left">
    ...
    <ul class="nav nav-tabs" id="tab-2">
      ...
      <li><a href="#tab2Edit"><i class="fa fa-pencil"></i> Edit Profile </a></li>
      ...
      <li><a href="#tab2Permissions"><i class="fa fa-chain"></i> Permissions </a></li>
    ...
    <div class="tab-content edit-profile">
            ...
            <div id="edit_rootwizard" class="col-md-12">
              ...
              <div class="form-wizard-steps">
                <ul class="wizard-steps">
                  ...
                  <li data-target="#step2" class=""> <a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title">Qualifications</span> </a> </li>
                  <li data-target="#step3" class=""> <a href="#tab3" data-toggle="tab"> <span class="step">3</span> <span class="title">Contact</span> </a> </li>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab2"> <br>
                  <h4 class="semi-bold">Step 2 - <span class="light">Qualifications</span></h4>
                  <br>
                  <!--row 2.1 start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                  ...
                  <div class="row form-row">
                    <div class="col-md-12">
                     ...
                     <?php print form_dropdown('system_roll_id',$other_user_roll,($user_data)?$user_data->user_roll_id:$this->session->flashdata('system_roll_id'),'id="system_roll_id" class="select2 form-control"'); ?>
                      <span>The employee's role within the HR system</span> </div>
                  </div>
                  <!--row 2.2 end-->
                  <!--row 2.3 start-->
                  <div class="row form-row">
                ...
                <div class="tab-pane" id="tab3"> <br>
                  <h4 class="semi-bold">Step 3 - <span class="light">Contact</span></h4>
                  <br>
                  <!--row 3.1 start-->
                  <div class="row form-row">
                    <div class="col-md-6">
                ...
                <div class="tab-pane" id="tab5"> <br>
                  ...
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_hidden('referance_id_1', ($user_data)?$user_data->referance_id_1:0); ?>
                    </div>
                  </div>
                  <!--row 5.1 end-->
                  <!--row 5.2 start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_company_name_1', 'id' => 'cv_reference_company_name_1', 'value' => ($user_data)?$user_data->cv_reference_company_name_1:$this->session->flashdata('cv_reference_company_name_1'), 'class' => 'form-control','placeholder' => 'Company Name')); ?>
                    </div>
                  </div>
                  <!--row 5.2 end-->
                  <!--row 5.3 start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_name_1', 'id' => 'cv_reference_name_1', 'value' => ($user_data)?$user_data->cv_reference_name_1:$this->session->flashdata('cv_reference_name_1'), 'class' => 'form-control','placeholder' => 'Referee Name')); ?>
                    </div>
                  </div>
                  <!--row 5.3 end-->
                  <!--row 5.4 start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_position_1', 'id' => 'cv_reference_position_1', 'value' => ($user_data)?$user_data->cv_reference_position_1:$this->session->flashdata('cv_reference_position_1'), 'class' => 'form-control','placeholder' => "Referee's Position")); ?>
                    </div>
                  </div>
                  <!--row 5.4 end-->
                  <!--row 5.5 start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_contact_number_1', 'id' => 'cv_reference_contact_number_1', 'value' => ($user_data)?$user_data->cv_reference_contact_number_1:$this->session->flashdata('cv_reference_contact_number_1'), 'class' => 'form-control','placeholder' => 'Contact number')); ?>
                    </div>
                  </div>
                  <!--row 5.5 end-->
                  <!--row 5.6 start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_email_1', 'id' => 'cv_reference_email_1', 'value' => ($user_data)?$user_data->cv_reference_email_1:$this->session->flashdata('cv_reference_email_1'), 'class' => 'form-control','placeholder' => 'Email Address')); ?>
                    </div>
                  </div>
                  <!--row 5.6 end-->
                  <!--row 5.7 start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_dropdown('cv_confirm_1',array(''=>'CV Confirmed','1'=> 'Yes','2'=>'No'),($user_data)?$user_data->cv_confirm_1:$this->session->flashdata('cv_confirm_1'),'id="cv_confirm_1" class="select2 form-control"'); ?>
                    </div>
                  </div>
                  <!--row 5.7 end-->
                  <!--row 5.1b start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_hidden('referance_id_2', ($user_data)?$user_data->referance_id_2:0); ?>
                    </div>
                  </div>
                  <!--row 5.1b end-->
                  <!--row 5.2b start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_company_name_2', 'id' => 'cv_reference_company_name_2', 'value' => ($user_data)?$user_data->cv_reference_company_name_2:$this->session->flashdata('cv_reference_company_name_2'), 'class' => 'form-control','placeholder' => 'Company Name')); ?>
                    </div>
                  </div>
                  <!--row 5.2b end-->
                  <!--row 5.3b start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_name_2', 'id' => 'cv_reference_name_2', 'value' => ($user_data)?$user_data->cv_reference_name_2:$this->session->flashdata('cv_reference_name_2'), 'class' => 'form-control','placeholder' => 'Referee Name')); ?>
                    </div>
                  </div>
                  <!--row 5.3b end-->
                  <!--row 5.4b start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_position_2', 'id' => 'cv_reference_position_2', 'value' => ($user_data)?$user_data->cv_reference_position_2:$this->session->flashdata('cv_reference_position_2'), 'class' => 'form-control','placeholder' => "Referee's Position")); ?>
                    </div>
                  </div>
                  <!--row 5.4b end-->
                  <!--row 5.5b start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_contact_number_2', 'id' => 'cv_reference_contact_number_2', 'value' => ($user_data)?$user_data->cv_reference_contact_number_2:$this->session->flashdata('cv_reference_contact_number_2'), 'class' => 'form-control','placeholder' => 'Contact number')); ?>
                    </div>
                  </div>
                  <!--row 5.5b end-->
                  <!--row 5.6b start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_input(array('name' => 'cv_reference_email_2', 'id' => 'cv_reference_email_2', 'value' => ($user_data)?$user_data->cv_reference_email_2:$this->session->flashdata('cv_reference_email_2'), 'class' => 'form-control','placeholder' => 'Email Address')); ?>
                    </div>
                  </div>
                  <!--row 5.6b end-->
                  <!--row 5.7b start-->
                  <div class="row form-row">
                    <div class="col-md-12">
                      ...
                      <?php print form_dropdown('cv_confirm_2',array(''=>'CV Confirmed','1'=> 'Yes','2'=>'No'),($user_data)?$user_data->cv_confirm_2:$this->session->flashdata('cv_confirm_2'),'id="cv_confirm_2" class="select2 form-control"'); ?>
                    </div>
                  </div>
                  <!--row 5.7b end-->
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="sub-title">
                    ...
                    <div class="col-md-6">Upload / Replace Document</div>
                ...
                <li>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["1"]) && $user_documents["1"] != "")
					{
					?>
					Photo:<a href="<?php print base_url().$user_documents["1"]; ?>" target="_blank"> <i class="fa fa-picture-o"></i></a>  
					<?php
					}
					?>
					</div>
                    <div class="col-md-6">
                    <label>Photo</label><input type="file" name="photo" id="photo" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf" placeholder="Do you have a .ppt?"></div>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["1"]) && $user_documents["1"] != "")
					{
					?>
					<a class="btn btn-sm btn-small btn-primary" href="<?php print base_url()?>list_user/delete_profile_document/<?php echo $user_data->user_unique_id?>/1">Delete  <i class="fa fa-trash-o"></i></a>
					<?php
					}
					?>
					</div>
                ...
                <li>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["2"]) && $user_documents["2"] != "")
					{
					?>
					Passport:<a href="<?php print base_url().$user_documents["2"]; ?>" target="_blank"> <i class="fa fa-book"></i></a>  
					<?php
					}
					?>
					</div>
                    <div class="col-md-6">
                    <label>Passport</label><input type="file" name="passport" id="passport" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf"></div>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["2"]) && $user_documents["2"] != "")
					{
					?>
					<a class="btn btn-sm btn-small btn-primary" href="<?php print base_url()?>list_user/delete_profile_document/<?php echo $user_data->user_unique_id?>/2">Delete  <i class="fa fa-trash-o"></i></a>
					<?php
					}
					?>
                    </div>
                ...
                <li>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["3"]) && $user_documents["3"] != "")
					{
					?>
					Degree:<a href="<?php print base_url().$user_documents["3"]; ?>" target="_blank"> <i class="fa fa-file-text"></i></a>  
					<?php
					}
					?>
					</div>
                    <div class="col-md-6">
                    <label>Degree Certificate</label><input type="file" name="Degree_Certificate" id="Degree_Certificate" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf"></div>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["3"]) && $user_documents["3"] != "")
					{
					?>
					<a class="btn btn-sm btn-small btn-primary" href="<?php print base_url()?>list_user/delete_profile_document/<?php echo $user_data->user_unique_id?>/3">Delete  <i class="fa fa-trash-o"></i></a>
					<?php
					}
					?>
                    </div>
                ...
                <li>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["4"]) && $user_documents["4"] != "")
					{
					?>
					Master:<a href="<?php print base_url().$user_documents["4"]; ?>" target="_blank"> <i class="fa fa-file-text"></i></a>  
					<?php
					}
					?>
					</div>
                    <div class="col-md-6">
                    <label>Master Certificate</label><input type="file" name="Master_Certificate" id="Master_Certificate" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf"></div>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["4"]) && $user_documents["4"] != "")
					{
					?>
					<a class="btn btn-sm btn-small btn-primary" href="<?php print base_url()?>list_user/delete_profile_document/<?php echo $user_data->user_unique_id?>/4">Delete  <i class="fa fa-trash-o"></i></a>
					<?php
					}
					?>
                    </div>
                ...
                <li>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["5"]) && $user_documents["5"] != "")
					{
					?>
					PHD:<a href="<?php print base_url().$user_documents["5"]; ?>" target="_blank"> <i class="fa fa-file-text"></i></a>  
					<?php
					}
					?>
					</div>
                    <div class="col-md-6">
                    <label>PHD Certificate</label><input type="file" name="Phd_Certificate" id="Phd_Certificate" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf"></div>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["5"]) && $user_documents["5"] != "")
					{
					?>
					<a class="btn btn-sm btn-small btn-primary" href="<?php print base_url()?>list_user/delete_profile_document/<?php echo $user_data->user_unique_id?>/5">Delete  <i class="fa fa-trash-o"></i></a>
					<?php
					}
					?>
                    </div>
                ...
                <li>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["6"]) && $user_documents["6"] != "")
					{
					?>
					Teaching Cert:<a href="<?php print base_url().$user_documents["6"]; ?>" target="_blank"> <i class="fa fa-file-text"></i></a>  
					<?php
					}
					?>
					</div>
                    <div class="col-md-6">
                    <label>Teaching Certificate</label><input type="file" name="Teaching_Certificate" id="Teaching_Certificate" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf"></div>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["6"]) && $user_documents["6"] != "")
					{
					?>
					<a class="btn btn-sm btn-small btn-primary" href="<?php print base_url()?>list_user/delete_profile_document/<?php echo $user_data->user_unique_id?>/6">Delete  <i class="fa fa-trash-o"></i></a>
					<?php
					}
					?>
                    </div>
                ...
                <li>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["8"]) && $user_documents["8"] != "")
					{
					?>
					Other Certificate:<a href="<?php print base_url().$user_documents["8"]; ?>" target="_blank"> <i class="fa fa-file-text"></i></a>  
					<?php
					}
					?>
					</div>
                    <div class="col-md-6">
                    <label>Other Certificate</label><input type="file" name="Other_Certificate" id="Other_Certificate" class="form-control input-sm" accept="image/jpg|image/jpeg|image/png|application/pdf"></div>
                    <div class="col-md-3">
					<?php
					if(isset($user_documents["8"]) && $user_documents["8"] != "")
					{
					?>
					<a class="btn btn-sm btn-small btn-primary" href="<?php print base_url()?>list_user/delete_profile_document/<?php echo $user_data->user_unique_id?>/8">Delete  <i class="fa fa-trash-o"></i></a>
					<?php
					}
					?>
                    </div>
      ...
      <div class="tab-pane generaltab" id="tab2Permissions">
...
<script>
	...
	$(document).ready(function(){
		checked_action(<?=$user_data->user_unique_id?>);
	});
</script>
<div class="sub-title"><?php echo $this->lang->line('privi_p_heading'); ?></div>
<?php 
...
<ul>
    ...
    <div class="row">
        ...
        <div class="checkbox check-primary">
			...
			echo form_checkbox('action[]', $menu_act_id, FALSE,'id="chkbox_'.$menu_act_id.'""');

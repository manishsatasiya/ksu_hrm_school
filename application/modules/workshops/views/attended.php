...
<script type="text/javascript" src="<?php print base_url(); ?>js/grid/workshop_attended.js"></script>
...
{
?>
	<?php /* ?><div id="add_model_link" class="hide"><a href="<?php print base_url(); ?>workshops/add_attendee/0/0/<?=$workshop_id?>" class="btn btn-success" data-target="#myModal" data-toggle="modal">Add Attendee <i class="fa fa-plus"></i></a></div><?php */ ?>
<?php 
}
?>
<!-- Modal -->
...
<div class="row-fluid">
	<div class="span12">
		<div class="grid simple ">
			...
			<table class="table" id="grid_workshop_attended">
				<thead>
					<tr>
						<th>&nbsp;</th>
						<th>ID</th>

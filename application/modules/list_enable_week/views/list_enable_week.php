...
<div class="grade-rpt list-enlbweek add-employee-pg">
  ...
  <div id="admin">
    ...
    <div id="searchbox" class="graderpt_search_box dataTables_wrapper">
      <div class="row">
        ...
        <fieldset>
        	<legend>
				<?php echo $this->lang->line('attendance_deadline_time'); ?>
                <?php print form_submit(array('name' => 'add_submit', 'id' => 'add_submit', 'value' 		=> 'Add', 'class' => 'input_submit btn btn-success')) ."\r\n";	?>
            </legend>          
        ...
        <div class="col-md-6">
          ...
          <fieldset>
          <legend>
          	<?php echo $this->lang->line('attendance_activation_time'); ?>
            <?php print form_submit(array('name' => 'add_submit', 'id' => 'add_submit', 'value' => 'Add', 'class' => 'input_submit btn btn-success')) ."\r\n"; ?>
          </legend>
          <div class="row form-row">
            <div class="col-md-6">
      ...
      <div class="row">
          ...
          <fieldset>
          <legend>
          	<?php echo $this->lang->line('teacher_attendance_pdf_settings'); ?>
            <?php print form_submit(array('name' => 'add_submit', 'id' => 'add_submit', 'value' => 'Add', 'class' => 'input_submit btn btn-success')) ."\r\n";?> 
          </legend>
          <div class="row form-row">
            <div class="col-md-6">
              <label class="form-label"> <?php echo $this->lang->line('pdf_settings'); ?> </label>
			  <?php echo $this->lang->line('export_type'); ?> 

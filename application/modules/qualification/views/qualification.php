...
<script type="text/javascript" src="<?php print base_url(); ?>js/grid/qualification.js"></script>
...
?>
	<div id="add_model_link" class="hide">
		<a href="qualification/add" class="btn btn-success" data-target="#myModal" data-toggle="modal"><?php echo $this->lang->line('add_new'); ?> <i class="fa fa-plus"></i></a>
	</div>
<?php 
}
?>
...
<div class="row-fluid">
	<div class="span12">
		<div class="grid simple ">
			...
			<table class="table" id="grid_qualification">
				<thead>
					<tr>
						<th style="width:77px">ID</th>
						<th>qualification</th>
                        <th>type</th>
                        <th>Show in datatable</th>
                        <th>Datatable display order</th>

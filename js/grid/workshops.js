...
$(document).ready( function () {
	$('#grid_workshops').bind('processing',function(e, oSettings, bShow){showHideDatatableProcessing(bShow)});
	dTable=	$('#grid_workshops').dataTable({
		bJQueryUI:false,
		bProcessing:true,
		bServerSide: true,
		sAjaxSource: CI.base_url+"workshops/index_json",
		"sDom": 'fCl<"clear">rtip',
		//"dom": 'T<"clear">lfrtip',
		//"sDom": '<"dataTables_header"lfr><"tbl_tools"CT<"clear">><"table_content"t>,<"widget-bottom"p>',
		"tableTools": {
            "sSwfPath": CI.base_url+"assets/plugins/jquery-datatable/extra/swf/copy_csv_xls_pdf.swf"
        },
		"oColVis": {
